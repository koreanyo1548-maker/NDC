...
{
    public class UI_EquipGrowth : UI_Popup
    {
        ...
        private void LevelInfoSet()
        {
            ...
            Get<TextMeshProUGUI>((int) Texts.T_EquipStat).text = GetStatString(meta.GetEquipStatType(), meta.GetEquipStat(),  meta.GetEquipGrowthStat());
            Get<TextMeshProUGUI>((int) Texts.T_OwnStat).text = GetStatString(meta.GetOwnStatType(),meta.GetOwnStat(), meta.GetOwnGrowthStat());
