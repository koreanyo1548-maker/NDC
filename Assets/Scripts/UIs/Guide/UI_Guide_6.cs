...
namespace UIs.Guide
{
    public class UI_Guide_6: UI_Guide
    {   
        ...
        public override void Next(UI_Base popup)
        {
            ...
            Timing.CallDelayed(0.15f, () =>
            {
                ...
                else if (popup is UI_EquipGrowth growth && growth.EquipmentType == EquipmentType.Weapon)
                {
                    growth.Check.ValueChanged = () => SelectAnotherWeaponInGrowth(popup);
        ...
        private void SelectAnotherWeaponInGrowth(UI_Base popup)
        {
            Next(popup);
        }
    }
