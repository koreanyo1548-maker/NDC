...
namespace UIs.Guide
{
    public class UI_Guide_26: UI_Guide
    {
        ...
        public override void Next(UI_Base popup)
        {
            ...
            Timing.CallDelayed(0.15f, () =>
            {
                ...
                else if (popup is UI_EquipPet equip)
                {
                    if (equip.CurMode == UI_EquipPet.Mode.Edit) Indicate("ActivePet1");
                }
                else if (popup is UI_Pet pet)
                {
                    if (pet.Have)
                    {
                        Indicate("B_Equip", true, GuideHandPositionType.X78Y59);
                    }
                    else
                    {
                        ActiveIndicator(false);
                ...
                else if (popup is UI_Book or UI_EquipGrowth or UI_EquipAwakening)
                {
                    ActiveIndicator(false);
                }
                else
