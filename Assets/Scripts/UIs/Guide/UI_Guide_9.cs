...
namespace UIs.Guide
{
    public class UI_Guide_9: UI_Guide
    {   
        ...
        public override void Next(UI_Base popup)
        {
            ...
            Timing.CallDelayed(0.15f, () =>
            {
                ...
                else if (popup is UI_EquipMerge merge && merge.EquipmentType == EquipmentType.Accessory)
                {
                    merge.Check.ValueChanged = () => SelectAnotherAccessoryInMerge(popup);
                ...
                else if (popup is UI_EquipMerge)
                {
                    ActiveIndicator(false);
                }
        ...
        private void SelectAnotherAccessoryInMerge(UI_Base popup)
        {
            Next(popup);
        }
    }
