...
{
    public class UI_UnlockAbilityPreset: UI_Popup
    {
        ...
        public void Set(CurrencyType abilityPreset, Action whenBuy)
        {
            if (!_isInit) Init();

            _shop = DbInGameShop.Get(Define.GetShopId(abilityPreset));
