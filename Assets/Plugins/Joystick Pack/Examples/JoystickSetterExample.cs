...
public class JoystickSetterExample : MonoBehaviour
{
    ...
    public void AxisChanged(int index)
    {
        ...
        {
            case 0:
                variableJoystick.AxisOptions = TestAxisOptions.Both;
                background.sprite = axisSprites[index];
                break;
            case 1:
                variableJoystick.AxisOptions = TestAxisOptions.Horizontal;
                background.sprite = axisSprites[index];
                break;
            case 2:
                variableJoystick.AxisOptions = TestAxisOptions.Vertical;
                background.sprite = axisSprites[index];
                break;
            default:
                break;
