...
namespace dynamicscroll
{
    ...
    public class DynamicScrollRect : ScrollRect
    {
        ...
        // void OnGUI()
        // {
        //     Rect position = new Rect(50, 150, Screen.width, Screen.height);
        //
        ...
        //
        //     GUI.Label(position, $"{velocity.magnitude}", style);   
        // }
        ...
        internal virtual Vector2 InternalCalculateOffset(ref Bounds viewBounds, ref Vector2 delta)
        {
